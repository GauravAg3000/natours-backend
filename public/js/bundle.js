...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZ3VydTA1IiwiYSI6ImNsNjM5MXBmZTA1Z24zYnBieXBhNzM3ZmoifQ.p0JWmF_x1IHDx8l-QBKavg";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              window.location.assign("/login"); // window.location.reload(true);
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51LRYurSEMUDxlO1rcZaBOuFOPf11KbGqQfTmiT5jWt6h4ZL2lzhRaPjpId43Xpdp81Q6S77nKUvfnGn35RG0YFqn004eHQ5eqN");
            _context.prev = 1;
            _context.next = 4;
